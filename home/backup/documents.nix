...
{
  home.file.".config/borgmatic/documents.yaml".text = lib.generators.toYAML { } {
    ...
    repositories = [
      {
        path = "ssh://borgbase-documents/./repo";
        label = "borgbase-backup";
        encryption = "repokey-blake2"; # Encryption method
      }
    ];

    encryption_passcommand = "sh -c 'pass borgbase.com/repos/documents | head -n1 | tr -d \"\\n\"'";

    # Base directory for relative paths
    working_directory = "/Users/maca";
